...
File integrity monitoring shows up across multiple compliance frameworks, including NIST CSF, PCI DSS, and ISO 27001, and it is a fundamental part of incident response. If an attacker modifies a config file, plants a backdoor, or deletes logs, you need a way to detect that something changed. Tools like OSSEC and Wazuh handle this in production, but I wanted to build the core logic myself to understand how baseline-and-compare integrity checking actually works.
